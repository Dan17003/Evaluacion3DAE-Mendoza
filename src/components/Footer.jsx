...
const Footer = () => {
    ...
    <h3 className="footer__title c-primary">MovieApp</h3>
    ...
    <ul className="list">
    <li><a href="#movies" className="footer__link">Now
    Showing</a></li>
    <li><a href="#coming-soon"
    className="footer__link">Coming Soon</a></li>
    <li><a href="#promotions"
    className="footer__link">Promotions</a></li>
    <li><a href="#about" className="footer__link">About
    Us</a></li>
    </ul>
    </div>
    <div className="footer__section">
